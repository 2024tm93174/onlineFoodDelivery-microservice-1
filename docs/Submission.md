...
A micro-services-based online food delivery system implementing **database‑per‑service**, **no cross‑DB joins**, with **replicated read models** in the Order service for statements and decoupling.
...
Attached docs/sequence-place-order.pdf.
