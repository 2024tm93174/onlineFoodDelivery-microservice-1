...
class Delivery(Base):
    ...
    assigned_at: Mapped = mapped_column(DateTime, server_default=func.now())
    picked_at: Mapped = mapped_column(DateTime, nullable=True)
    delivered_at: Mapped = mapped_column(DateTime, nullable=True)
