...
# Metrics
REQUEST_COUNT = Counter("delivery_service_http_requests_total", "Total HTTP requests", ["method", "path", "status"])
REQUEST_LATENCY = Histogram("delivery_service_http_request_latency_seconds", "Request latency", ["method", "path"])
